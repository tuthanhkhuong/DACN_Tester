...
public class ExcelUtilResult {
	...
	public static final String excelFileNameResult = "testData.xlsx";
	...
	public static void setExcelFile(String sheetName) throws IOException {
		...
		// Mở file Excel
		FileInputStream excelFile = new FileInputStream(excelFilePath + excelFileNameResult);
...
//		return cell.getStringCellValue();
	...
	public static void setCellData(String result, int rowNum, int colNum) throws IOException {
		...
		FileOutputStream fileOutResult = new FileOutputStream(excelFilePath + excelFileNameResult);
		
		excelWBook.write(fileOutResult);
		fileOutResult.flush();
		fileOutResult.close();
	}
